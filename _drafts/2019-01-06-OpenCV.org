...
** Required build dependencies
   :PROPERTIES:
   :CUSTOM_ID: required-build-dependencies
   :END:

We need CMake to configure the installation, GCC for compilation,
Python-devel and Numpy for building Python bindings etc.
...
** Configuring and Installing
   :PROPERTIES:
   :CUSTOM_ID: configuring-and-installing
   :END:

Now open a terminal window and navigate to the downloaded "opencv"
folder. Create a new "build" folder and navigate to it.
...
** Build opencv_contrib
   :PROPERTIES:
   :CUSTOM_ID: build-opencv_contrib
   :END:

[[https://github.com/opencv/opencv_contrib][Github]]
