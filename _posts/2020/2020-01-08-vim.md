...
- [vim-cheatsheet online doc](chrome-extension://gfbliohnnapiefjpjlpjnehglfpaknnc/pages/pdf_viewer.html?r=https://www.cs.cmu.edu/~15131/f17/topics/vim/vim-cheatsheet.pdf)
- [VIM学习笔记](https://zhuanlan.zhihu.com/p/25946307)

# Graphical Cheat Sheet

![vi-vim-tutorial-gif](http://www.viemu.com/vi-vim-cheat-sheet.gif)

![vi-vim-tutorial-gif](/assets/img/vi-vim-tutorial-gif/vi-vim-tutorial-1.gif)
![vi-vim-tutorial-gif](/assets//img/vi-vim-tutorial-gif/vi-vim-tutorial-2.gif)
![vi-vim-tutorial-gif](/assets//img/vi-vim-tutorial-gif/vi-vim-tutorial-3.gif)
![vi-vim-tutorial-gif](/assets/img/vi-vim-tutorial-gif/vi-vim-tutorial-4.gif)
![vi-vim-tutorial-gif](/assets/img/vi-vim-tutorial-gif/vi-vim-tutorial-5.gif)
![vi-vim-tutorial-gif](/assets/img/vi-vim-tutorial-gif/vi-vim-tutorial-6.gif)
![vi-vim-tutorial-gif](/assets/img/vi-vim-tutorial-gif/vi-vim-tutorial-7.gif)
...
# Plugins
## caw.vim
- <prefix> + c: comment before the first word,  行の最初の文字の前にコメント文字をトグル
- <prefix> + ,: comment on the head of the line, 行頭にコメントをトグル
...
# Reference
- [socketwiz/vim.markdown](https://gist.github.com/socketwiz/2645891)
